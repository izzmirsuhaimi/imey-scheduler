  ...
  return (
    <div
      ...
      style={{
        ...
        fontSize: settings.cellTextSize,
        display: "flex",
    ...
    >
      <div
        style={{
          fontSize: settings.cellTimeTextSize,
          fontWeight: 500,
          textShadow,
        }}
      >
...
export default function TimetableGrid({
  ...
  const gridDrawHeight = height - HEADER_HEIGHT;
  ...
  return (
    <div className="timetable-row">
      <div className="timetable-center">
        ...
        >
          {backgroundImage && (
            <img src={backgroundImage} alt="" className="timetable-grid__background" />
          )}
            ...
            {sortedHours.map((hour) => (
              <div
                ...
                style={{
                  ...
                  fontSize: settings.dayTimeTextSize,
          ...
          >
            {selectedDays.map((day, dayIndex) => {
              const columnWidth = (width - 40) / selectedDays.length;
